...
<div class="wrapper">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <a class="mybtn rounded-search" href="AboutBOT-form.php" style="float: right; text-decoration: none;">Add</a>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-lg-12">
                ...
                <!-- <table class="table border border-primary">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <img src="Images/Aboutus/Team4.webp" class="w-100">
                            </td>
                            <td>Ratan J. Batliboi</td>
                            <td>Board Chair & Hon Trustee</td>
                            <td>
                                <img src="Images/Aboutus/Team5.webp" class="w-100">
                            </td>
                            <td>Praveen Kadle</td>
                            <td>Trustee & Hon Treasurer</td>
                            <td>
                                <img src="Images/Aboutus/Team6.webp" class="w-100">
                            </td>
                            <td>Pervin Varma</td>
                            <td>Trustee</td>
                            <td>
    ...
    <?php if(isset($_POST['edit'])) { ?>
                <div class="row mt-4">
                    <div class="col-md-6 offset-md-3">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit About Us Board Of Trustees</h4>

...
include 'include/conn.php';
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE aboutusmc SET image1='$new_image', title1='$title1', subtitle='$subtitle' WHERE id=$id";
        } else {
            $sql = "UPDATE aboutusmc SET title1='$title1', subtitle='$subtitle' WHERE id=$id";
        }
        
        

        if ($conn->query($sql) === TRUE) {
            header("Location: AboutMC-table.php"); // Redirect to avoid form resubmission
            exit;
        } else {
    ...
    if (isset($_POST['delete'])) {
        $id = $_POST['id'];
        $sql = "DELETE FROM aboutusmc WHERE id=$id";
        $conn->query($sql);
    }
?>
...
<div class="wrapper">
    <div class="container-fluid">
      ...
      <div class="col-xl-9 col-lg-8 col-md-8">
        <div class="row mt-5">
            <div class="col-md-12">
                <h1 class="title mb-4"><u><?php echo $edit ? "Edit About Us Managing Committee" : "About Us Managing Committee"; ?></u></h1>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-md-12">
                <a class="mybtn rounded-search" href="AboutMC-form.php" style="float: right; text-decoration: none;">Add</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                ...
                <!-- <table class="table border border-primary">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <img src="Images/Aboutus/Team1.jpg" class="w-100">
                            </td>
                            <td>Puja Marwaha</td>
                            <td>Chief Executive</td>
                            <td>
                                <img src="Images/Aboutus/Team2.jpg" class="w-100">
                            </td>
                            <td>Yamini Kapoor</td>
                            <td>DIRECTOR - Resource Generation</td>
                            <td>
                                <img src="Images/Aboutus/Team3.webp" class="w-100">
                            </td>
                            <td>Vatsala Mamgain</td>
    ...
    <?php if(isset($_POST['edit'])) { ?>
                <div class="row mt-4">
                    <div class="col-md-6 offset-md-3">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit About Us Managing Committee</h4>

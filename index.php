...
<div class="container img-center">
    <div class="row">
        <div class="col">
          <div class="what"><b>What we do?</b></div>
        </div>
    </div>
    <div class="row">
        <div class="impact1 col-md-6">
          <img src="Images/impact2.jpg" alt="Img on Hover" class="read1 w-100">
        </div>
        <div class="col-md-6">
            <p class="what1">
              Our Organization are dedicated to ensuring that every child receives the education they deserve. Education is crucial for a progressive society, and it is essential to ensure that every child has access to high-quality education. In India, the government has introduced various programs aimed at providing accessible and free education to all children, especially those from marginalized communities.
            </p>
            <ul  class="list-impact">
              <li>Education</li>
              <li>Health</li>
              <li>Child Labour</li>
...
<br><br>
    ...
    <div class="container img-center">
        <div class="row">
            <div class="col-md-6">
                <div class="what2"><b class="our">Our Impact</b></div>
                <br><br>
                <p class="ours">We’ve worked on improving the lives of over 25,000 young people through direct practice.</p>
                <br><br>
                <p class="ourss">Young people from different backgrounds have a huge impact on us and all our activities. They highlight those parts of the society that are broken, so we can help them in all possible ways to regain hope and flourish in life.</p>
                <br><br>
                <div>             
                  <a href="impact.php" class="text-link mybtn rounded-search" target="_blank" aria-label="Text Link">READ MORE</a>
                 </a>
             </div>
            </div>

            <div class="impact col">
                <img src="Images/impact.jpg" alt="Img on Hover" class="read w-100">
            </div>
        </div>
    </div><br><br>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col">
          <img src="Images/Prgm5.png" alt="Bootstrap" class="w-100">
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid ">
        <div class="row ">
            <div class="col-lg-3  text-center  py-5" id="size1">
            ...
            <div class="col-lg-3  text-center  py-5" id="size2">
            ...
            <div class="col-lg-3  text-center  py-5" id="size3">
            ...
            <div class="col-lg-3  text-center  py-5" id="size4">
    ...
    <div class="map">
      <div class="reaches"><b>Reaches 2024-25</b></div><br>
         <div class="container-fluid text-center">
    <div class="row align-items-start">
      <div class="col-lg-4">
        <h1>Our numbers that speak</h1><br>
      ...
      <div class="col-lg-8" id="#counter">
        <div class="container-fluid text-center">
          <div class="reachs row">
              <div class="col-lg-5">
                  <b>Activities in</b>
                  <h1 class="reach" data-count="25">25</h1>
                  <b>states & union territories</b>
              </div>
              <div class="col-lg-5">
                  <b>Children Reached</b>
                  <h1 class="reach">8M</h1>
    ...
    <div>
      <img src="Images/map.png" alt="main Image" class="w-100">
    </div>

<hr>
<div class="reaches"><b>Our Partners</b></div>
<div class="container">
  <div class="row">
    <div class="col-md-2">
      <img src="Images/footlogo/footlogo1.jpg" alt="footer image" class="w-100">
    </div>
    <div class="col-md-2">
      <img src="Images/footlogo/footlogo2.jpg" alt="footer image" class="w-100">
    </div>
    <div class="col-md-2">
      <img src="Images/footlogo/footlogo3.png" alt="footer image" class="w-100">
    </div>
    <div class="col-md-2">
      <img src="Images/footlogo/footlogo4.jpg" alt="footer image" class="w-100">
    </div>
    <div class="col-md-2">
      <img src="Images/footlogo/footlogo5.jpg" alt="footer image" class="w-100">
    </div>
    <div class="col-md-2">
      <img src="Images/footlogo/footlogo6.jpg" alt="footer image" class="w-100">
    </div>
  </div>
</div><br><hr>
